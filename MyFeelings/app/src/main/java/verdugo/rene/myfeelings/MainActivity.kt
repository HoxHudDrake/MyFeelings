package verdugo.rene.myfeelings
...
import verdugo.rene.myfeelings.utilities.CustomCircleDrawable
import verdugo.rene.myfeelings.utilities.CustomBarDrawable
import verdugo.rene.myfeelings.utilities.Emociones
import verdugo.rene.myfeelings.utilities.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(!data){
            ...
            graphVeryHappy.background = CustomBarDrawable(this, Emociones
                ("Feliz",0.0F, R.color.orange,veryHappy)
            )
            graphHappy.background = CustomBarDrawable(this,Emociones
                ("Muy Feliz",0.0F, R.color.mustard,happy))
            graphNeutral.background = CustomBarDrawable(this,Emociones
                ("Neutral",0.0F, R.color.greenie,neutral))
            graphSad.background = CustomBarDrawable(this,Emociones
                ("Triste",0.0F, R.color.blue,sad))
            graphVerySad.background = CustomBarDrawable(this,Emociones
                ("Muy Triste",0.0F, R.color.deepBlue,verysad))
        }else{
            actualizarGrafica()
            iconoMayoria()
        }
    ...
    fun actualizarGrafica() {
        ...
        graphSad.background =
            CustomBarDrawable(this, Emociones("Triste", pS, R.color.blue, sad))
